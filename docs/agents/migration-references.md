...
- `.reference/drizzle-zero` for `drizzle-zero` schema generation and beta integration checks.
- `.reference/zero` for Zero, `zero-cache`, query helpers, mutators, and generated schema conventions.
